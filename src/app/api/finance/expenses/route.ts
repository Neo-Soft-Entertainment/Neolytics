...
import { createExpenseEntry } from "@/lib/finance-service";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return serverError(error instanceof Error ? error.message : "Não foi possível criar o lançamento de despesa.");
  }
}
