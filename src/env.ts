...
const envSchema = z.object({
  ...
  PRIVACY_HASH_SECRET: optionalString,
  PRIVACY_SUPPORT_EMAIL: optionalEmail,
  PRIVACY_MIN_COHORT_SIZE: z.coerce.number().int().positive().default(100),
  PRIVACY_REQUEST_DUE_DAYS: z.coerce.number().int().positive().default(15),
